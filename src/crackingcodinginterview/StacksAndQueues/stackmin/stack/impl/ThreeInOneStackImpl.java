package crackingcodinginterview.StacksAndQueues.stackmin.stack.impl;

import crackingcodinginterview.StacksAndQueues.stackmin.model.Range;
...
public class ThreeInOneStackImpl implements ThreeInOneStack {
    ...
    @Override
    public Object min(StackNumber stackNumber) {
        final Range range = findRange(stackNumber);
        ...
        for (int i = range.getMin(); i <= range.getHead(); i++) {
